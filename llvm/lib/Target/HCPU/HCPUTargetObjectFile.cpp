//===-- HCPUTargetObjectFile.cpp - HCPU Object Files ----------------------===//
//
...
static cl::opt<unsigned> SSThreshold(
    "hcpu-ssection-threashold", cl::Hidden,
    cl::desc("Small data and bss section threshold size (default = 8)"),
    cl::init(8));

void HCPUTargetObjectFile::Initialize(MCContext &Ctx, const TargetMachine &TM) {
  ...
  this->TM = &static_cast<const HCPUTargetMachine &>(TM);
}
...
bool HCPUTargetObjectFile::IsGlobalInSmallSection(
...
IsGlobalInSmallSectionImpl(const GlobalObject *GV,
  ...
  const HCPUSubtarget &Subtarget =
      *static_cast<const HCPUTargetMachine &>(TM).getSubtargetImpl();
...
MCSection *
HCPUTargetObjectFile::SelectSectionForGlobal(
