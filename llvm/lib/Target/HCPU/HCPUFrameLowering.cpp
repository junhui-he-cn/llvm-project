//===-- HCPUFrameLowering.cpp - HCPU Frame Information --------------------===//
//
...
const HCPUFrameLowering *HCPUFrameLowering::create(const HCPUSubtarget &ST) {
  return llvm::createHCPUSEFrameLowering(ST);
}
...
eliminateCallFramePseudoInstr(MachineFunction &MF, MachineBasicBlock &MBB,
  ...
  if (!hasReservedCallFrame(MF)) {
    ...
    if (I->getOpcode() == HCPU::ADJCALLSTACKDOWN)
      Amount = -Amount;
