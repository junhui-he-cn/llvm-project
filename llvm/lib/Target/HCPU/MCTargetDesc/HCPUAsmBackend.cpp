//===-- HCPUAsmBackend.cpp - HCPU Asm Backend  ----------------------------===//
//
...
//===----------------------------------------------------------------------===//
//
// This file implements the HCPUAsmBackend class.
//
//===----------------------------------------------------------------------===//
//

#include "MCTargetDesc/HCPUAsmBackend.h"
...
static cl::opt<bool> HasLLD("has-lld", cl::init(false),
                            cl::desc("HCPU: Has lld linker for HCPU."),
                            cl::Hidden);
...
HCPUAsmBackend::createObjectTargetWriter() const {
  return createHCPUELFObjectWriter(TheTriple);
}

/// ApplyFixup - Apply the \p Value for given \p Fixup into the provided
/// data fragment, at the offset specified by the fixup and following the
/// fixup kind as appropriate.
void HCPUAsmBackend::applyFixup(const MCAssembler &Asm, const MCFixup &Fixup,
...
HCPUAsmBackend::getFixupKindInfo(MCFixupKind Kind) const {
  ...
  const static MCFixupKindInfo Infos[HCPU::NumTargetFixupKinds] = {
...
bool HCPUAsmBackend::writeNopData(raw_ostream &OS, uint64_t Count,
                                  const MCSubtargetInfo *STI) const {
  return true;
}

// MCAsmBackend
MCAsmBackend *llvm::createHCPUAsmBackend(const Target &T,
                                         const MCSubtargetInfo &STI,
                                         const MCRegisterInfo &MRI,
                                         const MCTargetOptions &Options) {
  return new HCPUAsmBackend(T, STI.getTargetTriple());
}